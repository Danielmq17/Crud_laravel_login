    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @method('PUT')
                ...
                <div class="mb-3">
                    <label class="form-label" type="hidden">Id</label>
                ...
                <div class="grid grid-cols-1">
                    ...
                    <input name="documento" value="{{ $paciente->documento }}" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="number" required/>
                </div>
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Tipo Docuemnto:</label>
                    <input name="tipoDocumento" value="{{ $paciente->tipoDocumento }}" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" required/>
                </div>
                <div class="grid grid-cols-1">
                ...
                <div class="grid grid-cols-1">
                    ...
                    <input name="genero" value="{{ $paciente->genero }}" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" required/>
                </div>
                <div class="grid grid-cols-1">
